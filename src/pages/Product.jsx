        ...
        <div className='container my-5 py-2'>
          <div className='row'>
            ...
            <div className='col-md-6 col-md-6 py-5'>
              <h5 className='text-uppercase text-muted product-category'>
                {product.category}
              </h5>
              <h2 className='product-title'>{product.title}</h2>
              <p className='lead product-rating'>
                {product.rating && product.rating.rate}{" "}
                <i className='fa fa-star'></i>
              </p>
              <h4 className='my-4 product-price'>${product.price}</h4>
              ...
              return (
                <div key={item.id} className='col-md-3 col-sm-6 mb-4'>
                  <div className='card text-center h-100'>
                    <img
                      className='card-img-top p-3 similar-product-img'
                      src={item.image}
                      alt='Card'
                      height={200}
                      width={150}
